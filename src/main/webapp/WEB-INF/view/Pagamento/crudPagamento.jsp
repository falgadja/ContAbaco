...
<div class="esquerda">
    <div class="sidebar">
        ...
        <div class="nav">
            ...
            <a href="${pageContext.request.contextPath}/pagamento" class="botao selecionado"><img src="${pageContext.request.contextPath}/img/icone-pagamento-branco.png" alt="" style="width: 18px; height: 18px;"> Pagamento</a>

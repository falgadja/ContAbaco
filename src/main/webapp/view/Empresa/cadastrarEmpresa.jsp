...
<head>
    ...
    <style>
        ...
        *{ box-sizing:border-box; font-family:'Poppins', system-ui, -apple-system, 'Segoe UI', Roboto, Arial; margin:0; padding:0; }
        ...
        .container{
            width:100%;
            height:100%; /* Mantém 100% para o iframe */
            display:flex;
            align-items: flex-start; /* <-- MUDADO: Alinha ao topo */
            justify-content:center;
            background:transparent;
            overflow-y: auto; /* <-- ADICIONADO: Permite rolagem interna */
            padding-top: 24px; /* <-- ADICIONADO: Espaçamento */
            padding-bottom: 24px; /* <-- ADICIONADO: Espaçamento */
        }
...
<%-- Este formulário agora é otimizado para o modal --%>
<div class="container">
    <div class="form-inner">
        <div class="title">Adicionar</div>
        <div class="subtitle">Empresa</div>

        <%-- O target="_top" faz a página inteira recarregar após o submit, e não só o iframe --%>
        <form action="${pageContext.request.contextPath}/InserirEmpresa" method="post" target="_top">

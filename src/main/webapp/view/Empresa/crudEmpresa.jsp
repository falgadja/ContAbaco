...
<div class="esquerda">
        ...
        <div class="tabela empresa-style">
            <div class="tabela-container">
                <%
                    ...
                    // 2. Se a lista for nula (primeiro acesso à página, sem filtro), busca todos no DAO.
                    if (lista == null) {
                        EmpresaDAO dao = new EmpresaDAO();
                        lista = dao.listar(); // Assumindo que seu DAO tem o método listar()
                    }

                    // 3. Agora, verifica se a lista (filtrada ou não) tem conteúdo.
                ...
                <table>
                    ...
                    <tbody>
                    <%
                        // 4. Faz o loop na lista de empresas
                        for (Empresa e : lista) {
                    %>
                    <tr>
                        <td><%= e.getId() %></td>
                ...
                %>
            </div> <div class="in-table-modal" id="inTableModal" role="dialog" aria-hidden="true"
    ...
    (function () {
        ...
        function closeModal() {
            ...
            // Ela faz a tabela atualizar sozinha depois que você cadastra ou edita.
